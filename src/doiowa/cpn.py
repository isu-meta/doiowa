...
def get_publication_date(tree):
    ...
    try:
        ...
        return {"year": "1400", "month": "01", "day": "01"}
...
def get_reviewers(tree):
    reviewers_h3_xpath = (
        "//h3[text() = 'Reviewers']/following-sibling::p[1]/strong/text()"
    )
    reviewers_p_xpath = (
        "//p[strong/text() = 'Reviewers']/following-sibling::p[1]/strong/text()"
    )
...
def generate_xml(sources, timestamp, genre="report"):
    mds = []
